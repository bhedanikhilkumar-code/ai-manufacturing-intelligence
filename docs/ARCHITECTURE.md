# Architecture — Ai Manufacturing Intelligence
...
| Category | Value |
| --- | --- |
| Primary stack | Python, AI/ML |
| Repository type | Public portfolio |
| GitHub topics | analytics, carbon-reduction, data-science, energy-optimization, machine-learning, manufacturing, python |
