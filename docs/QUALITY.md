# Quality Standard — Ai Manufacturing Intelligence
...
| Area | Value |
| --- | --- |
| Detected stack | Python, AI/ML |
| Primary language | Python |
| Topics | analytics, carbon-reduction, data-science, energy-optimization, machine-learning, manufacturing, python |
